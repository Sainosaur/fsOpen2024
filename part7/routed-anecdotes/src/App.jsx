  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name='content' value={content.value} onChange={content.set} />
        </div>
        <div>
          author
          <input name='author' value={author.value} onChange={author.set} />
        </div>
        <div>
          url for more info
          <input name='info' value={info.value} onChange={info.set} />
        </div>
        <button type='submit' >create</button><button type='button' onClick={resetAll}>reset</button>
      </form>
    </div>
  )
